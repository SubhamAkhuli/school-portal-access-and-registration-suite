...
jQuery(document).ready(function($) {
    ...
    $.ajax({
        ...
        data: {
            'action': 'get_student_transfer_data_by_id',
            ...
            if (response && response.data) {
                ...
                if (student_data) {
                    ...
                    const studentBadgesHTML = `
                        <div class="student-badges text-end">
                    ...
                    function loadStudent(index) {
                        ...
                        $(".student-names").html(studentBadgesHTML);
                        ...
                        Object.keys(coursesByYear).sort().reverse().forEach(year => {
                            ...
                            const yearHeader = `
                                <tr class="academic-year-header text-start" data-year="${year}">
                                    <td style="background-color: #58595b;" class="text-white"><b>${year} | ATTENDANCE: <span class="attendance-days">${attendanceDays}</span> Days</b></td>
                                ...
                                yearContent += `
                                    <tr class="course-row" data-year="${year}">
                                        <td class="course-info  text-start">
                                            ...
                                            <p class="mb-0 d-none semester">${course.semester.charAt(0).toUpperCase() + course.semester.slice(1)}</p>
                                        </td>
