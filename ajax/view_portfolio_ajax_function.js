...
jQuery(document).ready(function($){
    ...
    //   console.log(registration_id);
      if(!registration_id){
        ...
        portfolioContainer.innerHTML = '<div class="alert alert-warning text-center">No documents found in the portfolio.</div>';
      }
    ...
    $.ajax({
        ...
        data: {
            action: 'get_portfolio_data_by_registration_id',
    ...
    $('#upload_btn').on('click', function(e){
        ...
        formData.append('action', 'save_portfolio_data_by_admin');
