...
let family_app_fee = 0; // As User pay Family Application Fee one time in Registration payment
...
jQuery(document).ready(function() {
    ...
    // Get all Incomplete Student data
    $.ajax({
        type: 'POST',
        url: ajax_object.ajax_url,
        data: {
            'action': 'get_incomplete_student_data',
        },
        success: function (data) {
            ...
            if (data.success) {
                ...
                // Fee Setting
                EachStudentPayBelow_8 = response.each_student_pay_below_8;
                EachStudentPayAfter_8 = response.each_student_pay_after_8;
                annualRegistrationFee = response.processing_fee; // Processing Fee
                transferFee = response.transfer_fee; // Transfer Fee
                // family_app_fee = response.family_app_fee;
                family_app_fee = 0 ; // As User pay Family Application Fee one time in Registration payment

                // console.log("EachStudentPayBelow_8: ", EachStudentPayBelow_8);
                // console.log("EachStudentPayAfter_8: ", EachStudentPayAfter_8);
                // console.log("annualRegistrationFee: ", annualRegistrationFee);
                // console.log("transferFee: ", transferFee);
                // console.log("family_app_fee: ", family_app_fee);

                // Year Paying
                $('.courseYearPaying').html(response.year_paying);

                // set Parent email id 
                $('#parent_email').val(data.email);
                if (data.data.student_data.length > 0) {
                    data.data.student_data.forEach(student => {
                        ...
                        if (studentTransfer) {
                            ...
                            $('.student_transfer #school_number').val(formatPhoneNumber(studentTransfer.school_number, studentTransfer.school_number_country_code));
    ...
    $('.next_to_student').on('click', function () {
        ...
        let yearPaying = $('.courseYearPaying').html();
        let student_id = $('#student_id').val();
        // console.log("Year Paying:", yearPaying);
    ...
    $('.add_student_btn').click(function () {
        ...
        $('.add_student .reg_1 .ans1 option[value=-1]').attr('selected', 'selected');
    ...
    $('.student_transfer #set_additional_values').on("change", function () {
        ...
        if (check_information === 'yes') {
            ...
            if (student_tranfer) {
                ...
                $('.student_transfer #school_number').val(formatPhoneNumber(student_tranfer.school_number, student_tranfer.school_number_country_code));
                ...
                $('.student_transfer #school_county').val(student_tranfer.school_county).trigger('change'); 
    ...
    $('.next_to_add_course').on('click', function () {
        ...
        $('.error-message').remove();
        let error = 0;
        // console.log('data before Course == >', data);
        ...
        // if (!school_name || !school_number || !school_email || !school_address || !school_city || !school_zip_code || !school_state == '-1' || school_county =='-1' || !school_last_date) {
            ...
            // console.log('school_number == >', school_number);
            // console.log('school_email == >', school_email);
            // console.log('school_address == >', school_address);
            // console.log('school_city == >', school_city);
            // console.log('school_zip_code == >', school_zip_code);
            // console.log('school_state == >', school_state);
            // console.log('school_county == >', school_county);
            // console.log('school_last_date == >', school_last_date);
...
//    })
    ...
    function setPayment() {
        ...
        data.map(function (item) {
            //console.log('item.questions.q3.ans3 == >', item.questions.q3.ans3);
        ...
        appendCartItem('Family Application Fee', 1, family_app_fee);
        appendTrasactionItems('Family Application Fee', 1, family_app_fee);
        // ################## Set Family Application fee
        ...
        Total += parseInt(family_app_fee) + parseInt(annualRegistrationFee) + parseInt(transferFee * addTransferFee);
        ...
        //     let img_url = student_profile_pic.replace('http://', 'https://');
            ...
            data.forEach(function(studentItem, index) {
                ...
                $('.studentSummaryBox').append(` 
                    <div class="row studentSummary d-flex align-items-center justify-content-center">
                        <div class="col-md-1 col-3">
                            <img src="${img_url}" alt="" srcset="">
                        </div>
                        <div class="col-md-8 col-5" style="padding-left: 50px;">
                                ...
                                <tr class="${idx}" onkeyup="editCourse(${idx})" onClick="editCourse(${idx})" onchange="editCourse(${idx})">
                                    <td class="selectCourse">
                                        <div style="display:flex;width: 250px;">
                                            ...
                                            &nbsp;<span style="color:#456fb6" data-toggle="popover" data-placement="bottom" data-original-title="" data-content="Select the general subject area for this course">
                                        ...
                                        &nbsp;<span style="color:#456fb6;position:absolute" data-toggle="popover" data-placement="bottom" data-original-title="" data-content="List the specific course name">
                                            <i class="fas fa-info-circle"></i>
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <div style="width: 230px;">
                                            <span onClick="chooseSemester(${idx},'fall','sem1')" class="sem1 badge badge-pill ${item.semester.search('fall') !== -1 ?  'text-bg-primary' : 'text-bg-secondary'}">Fall</span>
                                            <span onClick="chooseSemester(${idx},'spring','sem2')" class="sem2 badge badge-pill ${item.semester.search('spring') !== -1 ?  'text-bg-primary' : 'text-bg-secondary'}">Spring</span>
                                            <span onClick="chooseSemester(${idx},'summer','sem3')" class="sem3 badge badge-pill ${item.semester.search('summer') !== -1 ?  'text-bg-primary' : 'text-bg-secondary'}">Summer</span>
                                            &nbsp;<span style="color:#456fb6" data-toggle="popover" data-placement="bottom" data-original-title="" data-content="Select which semester(s) this course will be taught. If this course will be taught year-round select all 3 semesters">
                                                <i class="fas fa-info-circle"></i>
                                            </span>
                                        </div>
                                    </td>
                                    <td class="grade">
                                        <div>
                                            ...
                                            &nbsp;<span style="color:#456fb6" data-toggle="popover" data-placement="bottom" data-original-title="" data-content="Leave course grade as In Progress. You will be able to assign grades for each course within your parent portal account">
                                                <i class="fas fa-info-circle"></i>
                                            </span>
                                        </div>
                                    </td>
                                    ...
                                    ${
                                        ...
                                        ? `<td class="additional">
                                            <div style="display:flex; align-items:center">
                                                ...
                                                &nbsp;<span style="color:#456fb6" data-toggle="popover" data-placement="bottom" data-original-title="" data-content="For all regular/standard high school courses select Standard Course. If this high school course qualifies for AP/CLEP/Dual Enrollment select the appropriate option. Please Note: we require official exam results/transcripts in order to list the course appropriately as such on the student’s transcript.">
                                                    <i class="fas fa-info-circle"></i>
                                                </span>
                                            </div>
                                        </td>`
                                    ...
                                    <td class="description">
                                        <div style="display:flex;">
                                            ...
                                            &nbsp;<span style="color:#456fb6" data-toggle="popover" data-placement="bottom" data-original-title="" data-content="List the specific book or online course you are utilizing and/or describe how this course will be taught.">
                                                <i class="fas fa-info-circle"></i>
                                            </span>
                                        </div>
                                    </td>
    ...
    $('.chooseSemester').on("click", function () {
        ...
        if (fall && spring) {
            // $('#' + id + ' .credit select').val('1.50').trigger('change');
            $('#' + id + ' .credit input').val('1.00');
        }
    ...
    //If a user logs out or closes their browser window prior to completing registration, 
    // this program save their progress when the parent logs back in later. 
    let setUnsaveDataOnce = true;
    ...
    // Contact Number Format Function XXX-XXX-XXXX
