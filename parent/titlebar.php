        ...
        <div class="d-flex justify-content-between gap-1 flex-wrap">
            <div class="dropdown">
                <button class="dropdown-toggle" id="dropdownMenuButton">
                    <img src="<?php echo plugin_dir_url(dirname(__FILE__)) ; ?>/img/user-1.jpg" class="profile-icon" height="35" alt="user">
                </button>
                <div class="dropdown-menu">
                    <a class="dropdown-item l-menu-link d-flex" href="./transaction"><span class="icon-holder"><i class="fas fa-money-bill-wave"></i></span> Transactions</a>
                    <a class="dropdown-item l-menu-link d-flex" href="./registrationdata"><span class="icon-holder"><i class="fas fa-database"></i></span> Registration Details</a>
                    <a class="dropdown-item l-menu-link d-flex" href="./my-account"><span class="icon-holder"><i class="fa-solid fa-user"></i></span> My Account</a>
