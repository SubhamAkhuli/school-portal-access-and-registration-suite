...
<!-- <script src="<?php echo plugin_dir_url(__FILE__); ?>ajax/view_class_ajax_function.js"></script> -->
<script src="<?php echo plugin_dir_url(dirname(__FILE__)); ?>ajax/view_class_ajax_function.js"></script>